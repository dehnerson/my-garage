...
const addTitles = (vehicle) => {
    ...
    if (vehicle.model) {
        vehicle.primaryTitle = vehicle.model;

        if (vehicle.manufacturer) {
            vehicle.primaryTitle = vehicle.manufacturer + " " + vehicle.model;

            if (vehicle.version) {
                vehicle.primaryTitle = vehicle.manufacturer + " " + vehicle.model + " " + vehicle.version;
            }
        }
    } else if (vehicle.manufacturer) {
        vehicle.primaryTitle = vehicle.manufacturer;
    }

    vehicle.secondaryTitle = "";

    if (vehicle.licensePlate) {
        vehicle.secondaryTitle = vehicle.licensePlate;
    } else if (vehicle.vin) {
        vehicle.secondaryTitle = vehicle.vin;
    }
}
